...
public class UnicastRequestEncoder
{
    ...
    private final UnicastRequestEncoder parentMessage = this;
    ...
    public UnicastRequestEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
        this.buffer = buffer;
        this.offset = offset;
